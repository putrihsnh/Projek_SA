...
dataset = [
    ...
    {"Nilai uang": 600, "Hasil greedy": [1, 0, 1, 0]},
    {"Nilai uang": 700, "Hasil greedy": [0, 1, 1, 0]},
    {"Nilai uang": 800, "Hasil greedy": [1, 1, 1, 0]},
    {"Nilai uang": 900, "Hasil greedy": [2, 1, 1, 0]},
    {"Nilai uang": 1000, "Hasil greedy": [0, 0, 0, 1]},
    {"Nilai uang": 1100, "Hasil greedy": [1, 0, 0, 1]},
    {"Nilai uang": 1200, "Hasil greedy": [2, 0, 0, 1]},
    {"Nilai uang": 1300, "Hasil greedy": [3, 0, 0, 1]},
    {"Nilai uang": 1400, "Hasil greedy": [4, 0, 0, 1]},
    {"Nilai uang": 1500, "Hasil greedy": [0, 0, 1, 1]},
    {"Nilai uang": 1600, "Hasil greedy": [1, 0, 1, 1]},
    {"Nilai uang": 1700, "Hasil greedy": [2, 0, 1, 1]},
    {"Nilai uang": 1800, "Hasil greedy": [3, 0, 1, 1]},
    {"Nilai uang": 1900, "Hasil greedy": [4, 0, 1, 1]},
    {"Nilai uang": 2000, "Hasil greedy": [5, 0, 1, 1]}
]
...
tombol_hitung = tk.Button(root, text="Hitung nilai Tukar", command=hitung_kembalian_dan_tampilkan)
tombol_hitung.pack()
